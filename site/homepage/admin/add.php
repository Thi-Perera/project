...
if ($_POST) {
    ...
    $qty     = (int) $_POST['qty'];
    $image1   = "/site/homepage/images/productimages/" . trim($_POST['image1']);
    $image2   = "/site/homepage/images/productimages/" . trim($_POST['image2']);
    $image3   = "/site/homepage/images/productimages/" . trim($_POST['image3']);
